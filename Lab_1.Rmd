...
2. Questions asked in the exercise text may be repeated in a test. Write down answers to these and be sure to answer the corresponding test (Test 1 in LM1) before the deadline.
...
rubrik <- data.frame(Questions = c("Histograms", "Text figures", "Answers to Questions"),
                     Level_1 = c("1 points: The hand-in only has 1 histogram",
                                 "2 points: The hand-in has 2 histograms",
                                 "3 points: The hand-in has 2 histograms with different colors"),
                     Level_2 = c("0.5 points: The text describing the charts is missing",
                     "1 points: The text describing the charts does not explained well
                                 ",
                     "1.5 points: All histograms are well explained"),
                     Level_3 = c("1 points: At least 2 answers are correct",
                                 "2 points: At least 4 answers are correct",
